...
"
    ...
    let acknowledge: String = "This was autogenerated from my Rust script, check out: [src/main.rs](https://github.com/krshrimali/rust-leetcode/blob/main/src/main.rs).".to_string();
...
Full disclosure: I was inspired by [UncleScientist](https://www.youtube.com/c/UncleScientist) to do it this way, specially the testing.".to_string();
    ...
    file.write_all(b"\n\n")?;
    file.write_all(acknowledge.as_bytes())?;
    file.flush()?;
    Ok(())
}
